...
check <- function(){
   ...
   total <- sum(filter(c, date==Sys.Date()-1)$confirmed_cases)
   ex_china <- sum(filter(c, date==Sys.Date()-1 & country_region!="China")$confirmed_cases)
   us <- sum(filter(c, date==Sys.Date()-1 & country_region=="US")$confirmed_cases)
   ...
   new <- sum(filter(c, date==Sys.Date()-1)$new_confirmed_cases) 
   new_ex_china <- sum(filter(c, date==Sys.Date()-1 & country_region!="China")$new_confirmed_cases)
   new_us <- sum(filter(c, date==Sys.Date()-1 & country_region=="US")$new_confirmed_cases)
   ...
   total <- sum(filter(c, date==Sys.Date()-1)$deaths)
   ex_china <- sum(filter(c, date==Sys.Date()-1 & country_region!="China")$deaths)
   us <- sum(filter(c, date==Sys.Date()-1 & country_region=="US")$deaths)
   ...
   new <- sum(filter(c, date==Sys.Date()-1)$new_deaths) 
   new_ex_china <- sum(filter(c, date==Sys.Date()-1 & country_region!="China")$new_deaths)
   new_us <- sum(filter(c, date==Sys.Date()-1 & country_region=="US")$new_deaths)
